...
namespace TekkenMinimalAPI.Utilidades
{
    ...
    {
        public const string IssuerPro = "oswe-app";
        ...
        public static IEnumerable<SecurityKey> ObtenerLlave(IConfiguration configuration) => ObtenerLlave(configuration, IssuerPro);
        ...
        public static IEnumerable<SecurityKey> ObtenerTodasLasLlaves(IConfiguration configuration)
        {
            ...
            foreach (var signingKey in signinkeys)
            {
